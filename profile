...
export FZF_DEFAULT_COMMAND='(git_root=`git rev-parse --show-toplevel` && git_root=`echo $git_root | sed "s#$HOME#~#"` && git ls-tree --full-tree -r --name-only HEAD | xargs -I{} echo $git_root/{} || ag -l --hidden -g "")'
